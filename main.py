...
def start_game():
    ...
    if winner == "Tie":
        Label(main_screen, text=winner, font=(
            'calibri', 20), bg='white', fg="green").place(x=200, y=450)
    else:
        Label(main_screen, text=winner+" Wins !!",
              font=('calibri', 20), bg='white', fg="green").place(x=200, y=450)
...
red_horse = canvas.create_image(
    red_horse_x, red_horse_y, anchor=NW, image=red_horse_img)
blue_horse = canvas.create_image(
    blue_horse_x, blue_horse_y, anchor=NW, image=blue_horse_img)

l1 = Label(main_screen, text='Select your horse',
           font=('calibri', 20), bg='white')
l1.place(x=230, y=280)

l2 = Label(main_screen, text='Click play when ready',
           font=('calibri', 20), bg='white')
l2.place(x=200, y=330)

b1 = Button(main_screen, text='Play!', height=2, width=15,
            bg='white', font=('calibri', 10), command=start_game)
